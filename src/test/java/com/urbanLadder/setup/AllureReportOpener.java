	...
	public static void openAllureReport() {
        try {
            ...
            ProcessBuilder generate = new ProcessBuilder(
                ...
                "C:\\Users\\2407167\\Downloads\\allure-commandline-2.29.0\\allure-2.29.0\\bin\\allure.bat", "generate", "target/allure-results", "-o", "target/allure-report", "--clean"
            );
            ...
            ProcessBuilder open = new ProcessBuilder(
                "C:\\Users\\2407167\\Downloads\\allure-commandline-2.29.0\\allure-2.29.0\\bin\\allure.bat", "open", "target/allure-report"
            );
            open.inheritIO();
